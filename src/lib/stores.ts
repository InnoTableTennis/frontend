...
import type {
	filterPlayerFormStore,
	filterTournamentFormStore,
	filterMatchFormStore,
	addPlayerFormStore,
...
const FILTER_PLAYER_FORM: filterPlayerFormStore = {
	name: '',
	telegramAlias: '',
	minRating: '',
	maxRating: '',
};
const FILTER_TOURNAMENT_FORM: filterTournamentFormStore = {
	title: '',
	minParticipants: '',
	maxParticipants: '',
	startDateString: '',
...
const FILTER_MATCH_FORM: filterMatchFormStore = {
	name: '',
	score: '',
	minDateString: '',
	maxDateString: '',
